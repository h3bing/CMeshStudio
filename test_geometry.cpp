...
int main() {
    ...
    // 创建一个实体来测试四面体
    std::shared_ptr<PEntity> tetrahedron = doc.createEntity("tetrahedron");
    ...
    // 创建一个实体来测试八面体
    std::shared_ptr<PEntity> octahedron = doc.createEntity("octahedron");
    ...
    // 创建一个实体来测试十二面体
    std::shared_ptr<PEntity> dodecahedron = doc.createEntity("dodecahedron");
